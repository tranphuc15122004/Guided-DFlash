...
2. Enhanced Negative Sampling: The negative context is generated by applying dropout and noise to the target hidden states, creating a more challenging contrastive learning scenario for the draft model.
...
def compute_contrastive_draft_logits(
    ...
    paired_noise_embedding = torch.cat([noise_embedding, noise_embedding], dim=0)
...
def dflash_generate(
    ...
    while start < max_length:
        ...
        if block_size > 1:
            ...
            first_draft_logits, second_draft_logits = compute_contrastive_draft_logits(
                model=model,
                target=target,
...
def main() -> None:
    ...
    parser.add_argument("--vcd-alpha", type=float, default=0.1)
