...
# Submit a small/large alpha data-collection job to A100 queue on Gadi.
# Usage:
#   bash script/run_a100_alpha_collect.sh
#   DATASET=gsm8k WALLTIME=01:00:00 bash script/run_a100_alpha_collect.sh
...
RUN_TAG="${RUN_TAG:-a100_collect_${DATASET}_${START_INDEX}_${NUM_INSTANCES}}"
...
echo "Submitting A100 alpha collection job with settings:"
...
LOG_FILE="logs/a100_alpha_collect_\${PBS_JOBID}.log"
...
echo "Tail log: tail -f logs/a100_alpha_collect_${JOB_ID}.log"
